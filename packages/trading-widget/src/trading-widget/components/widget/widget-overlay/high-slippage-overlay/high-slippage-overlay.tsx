...
export const HighSlippageOverlay: FC<OverlayProps> = ({ type }) => {
  ...
  return (
    <Layout.Overlay className="dtw-justify-between dtw-gap-y-1">
      ...
      <ul className="dtw-list-inside dtw-list-disc dtw-flex dtw-flex-col dtw-gap-y-1 dtw-text-sm dtw-text-[color:var(--panel-secondary-content-color)] dtw-max-h-28 dtw-overflow-y-scroll">

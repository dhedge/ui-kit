...
export const DEFAULT_TRANSLATION_DATA: TranslationMap = {
  ...
  batchTransactionsWarning:
    "Approve and deposit will be batched into a single transaction. Disable batching in Trading Settings if you prefer separate transactions or if your wallet doesn't support batching.",
}

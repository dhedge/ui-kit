...
export const PriceInput: FC<PriceInputProps> = (props) => {
  ...
  return (
    ...
    >
      <div className="dtw-text-[length:var(--limit-order-input-label-font-size,var(--limit-order-font-size-sm))] dtw-leading-[var(--limit-order-input-label-line-height,var(--limit-order-line-height-sm))] dtw-font-[var(--limit-order-input-label-font-weight,var(--limit-order-font-weight-light))] dtw-gap-x-2">
        {label}
      </div>
      <div className="transparent-scrollbar dtw-flex-1 dtw-overflow-x-auto">
        <input
          className="dtw-appearance-none dtw-bg-transparent dtw-text-[color:var(--limit-order-input-content-color,var(--limit-order-content-color))] placeholder:dtw-text-[color:var(--limit-order-input-placeholder-color,var(--limit-order-secondary-content-color))] dtw-text-[length:var(--limit-order-input-font-size,var(--limit-order-font-size-sm))] dtw-leading-[var(--limit-order-input-line-height,var(--limit-order-line-height-sm))] dtw-font-[var(--limit-order-input-font-weight,var(--limit-order-font-weight-light))] dtw-outline-none focus:dtw-outline-none lg:dtw-text-[length:var(--limit-order-input-font-size-lg,var(--limit-order-font-size-lg))] lg:dtw-leading-[var(--limit-order-input-line-height-lg,var(--limit-order-line-height-lg))] dtw-w-full"
          ref={inputRef}
          autoFocus={autoFocus}
          type="number"
          min={0}

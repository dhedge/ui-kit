...
export const EXTREMELY_SHORT_POLLING_INTERVAL = 5_000
...
export const DEFAULT_RECEIVED_VALUE_GAP = 0.02 // %
export const DEFAULT_SWAP_TRANSACTION_SLIPPAGE = 0.75 // %
...
export const NATIVE_TOKEN_DEPOSIT_GAS_LIMIT = 30000000
...
export const SWAP_QUOTE_REFRESH_INTERVAL_MS = 20000
export const DEFAULT_NOTIFICATION_DURATION_MS = 15000

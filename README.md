...
> | `poolFallbackData` | { address: `Address`; managerLogicAddress?: `Address`; poolCompositions: `PoolComposition[]`; tokenPrice?: `string`; apy?: { value: `number`; currency: `'USD' \| 'ETH'` }; performanceFeeNumerator: `string`; streamingFeeNumerator: `strimg`; entryFeeNumerator: `string`; exitFeeNumerator: `string` } | { address: `AddressZero` }                                                                                                 | Current active pool fallback data to override or extend contract's response                     |
...
> | `exitFee`                        | string | Exit Fee                                                                                                                                                                              |             |
> | `entryFeeExplanation`            | string | Entry fee is charged in vault's tokens.                                                                                                                                               |             |
> | `exitFeeExplanation`             | string | Exit fee is charged in vault's tokens.                                                                                                                                                |             |
